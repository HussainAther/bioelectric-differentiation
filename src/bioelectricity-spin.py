...
coupling_strength = 0.1  # Local coupling
long_range_coupling_strength = 0.05  # Long-range entanglement strength
long_range_radius = 3  # Max radius for long-range spin interaction
...
# Long-range coupling: average spin in a radius around the point
    ...
    for i in range(1, voltage.shape[0] - 1):
        for j in range(1, voltage.shape[1] - 1):
            for k in range(1, voltage.shape[2] - 1):
                ...
                # QTM + Local & Long-range Spin Coupling
